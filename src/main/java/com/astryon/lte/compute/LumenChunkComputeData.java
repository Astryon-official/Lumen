...
public class LumenChunkComputeData {
    ...
    /*
     * LTE generated terrain modification data.
     *
     * Positive values raise terrain.
     * Negative values lower terrain.
     */
    public final double[] heightModification;
    ...
    public LumenChunkComputeData(
        ...
        /*
         * LTE output buffer.
         * Stores terrain changes generated by LTE.
         */
        this.heightModification =
                new double[256];
